      ...
      >
        {showPassword ? (
          ...
          <FaEye className="text-gray-500  relative left-4" />
                    ...
                    <a className="forgot-password-link text-[#a31621] text-sm underline self-end" href="#">Forgot Password</a>
                ...
                <p className="signup-link text-sm text-center text-[#fcf7f8]">
                    ...
                    <a className="signup-link text-[#a31621] underline" href="#"> Sign up now</a>
                </p>
            </div>
        </section>
    );
